...
'
  ...
  Call SendMessage(CommandFormHandle, WM_COMMAND, 190, 0&) ' "Открыть протокол..."
  Call SendMessage(CommandFormHandle, WM_COMMAND, 203, 0&) ' "Очистить задание"
  ProtokolHandle = Find_TKZ_Window_Handle("TForm3")
  ProtokolMemo = Find_SubClass_Recurce(ProtokolHandle, "TMemo")
  Call SendMessage(ProtokolHandle, WM_COMMAND, 250, 0&)    ' "Очистить протокол"
  ...
  Call SendMessage(CommandFormHandle, WM_COMMAND, 182, 0&) ' "Расчет с эквиваленированием"
